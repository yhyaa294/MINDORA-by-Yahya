...
export default function Home() {
  return (
    <main className="min-h-screen bg-white flex flex-col">
      ...
      {/* SECTION 1: EMERGENCY BAR (Bridge) */}
      ...
      {/* SECTION 2: MENGAPA SEHATI+? (Latar Belakang) */}
      <section className="py-24 bg-slate-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
            ...
            <div className="grid md:grid-cols-3 gap-8">
                {/* Card 1 */}
                <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-slate-100 hover:shadow-xl transition-all duration-300 group">
      ...
      {/* SECTION 3: FEATURES (Updated 5 Core Features) */}
      <section id="features" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-2 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-[2.5rem] p-10 text-white relative overflow-hidden group">
                ...
                <div className="bg-rose-50 rounded-[2.5rem] p-8 border border-rose-100 hover:shadow-lg transition-all duration-300">
                ...
                <div className="bg-indigo-50 rounded-[2.5rem] p-8 border border-indigo-100 hover:shadow-lg transition-all duration-300">
                ...
                <div className="bg-amber-50 rounded-[2.5rem] p-8 border border-amber-100 hover:shadow-lg transition-all duration-300">
                ...
                <div className="bg-emerald-50 rounded-[2.5rem] p-8 border border-emerald-100 hover:shadow-lg transition-all duration-300">
      ...
      <section className="py-24 bg-slate-900 text-white">
        <div className="max-w-7xl mx-auto px-4">
            ...
            {/* Lead Developer */}
            <div className="max-w-3xl mx-auto bg-slate-800/50 border border-slate-700 rounded-3xl p-8 mb-12 flex items-center gap-6 hover:bg-slate-800 transition-colors">
                <div className="w-20 h-20 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center font-bold text-2xl">Y</div>
                <div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4">
            ...
            <div className="space-y-4">
                <FaqItem question="Apakah aplikasi ini berbayar?" answer="100% GRATIS untuk seluruh siswa SMANERO." />
                <FaqItem question="Apakah guru BK bisa membaca chat saya?" answer="Tidak. Chat AI bersifat privat. Konseling GenRe bersifat rahasia profesional." />
                <FaqItem question="Bagaimana cara mulainya?" answer="Cukup klik tombol Masuk, login dengan emailmu, dan mulai cerita." />
            </div>
        </div>
      </section>
...
function FaqItem({ question, answer }: { question: string, answer: string }) {
    ...
    return (
        <div className="border border-slate-100 rounded-2xl overflow-hidden">
            <button onClick={() => setIsOpen(!isOpen)} className="w-full flex items-center justify-between p-6 bg-slate-50 hover:bg-slate-100 transition-colors text-left">
                <span className="font-bold text-slate-800 text-lg">{question}</span>
                <ChevronDown className={`w-5 h-5 text-slate-400 transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`} />
            </button>
            <div className={`grid transition-[grid-template-rows] duration-300 ease-out ${isOpen ? 'grid-rows-[1fr]' : 'grid-rows-[0fr]'}`}>
                <div className="overflow-hidden"><div className="p-6 pt-0 bg-slate-50 text-slate-600 leading-relaxed">{answer}</div></div>
            </div>
        </div>
    );
}
